...
class School extends Dbconfig {	
    ...
    public function __construct(){
        if(!$this->dbConnect){ 		
            ...
            // $conn = mysqli_connect($this->hostName, $this->userName, $this->password, $this->dbName) or die("Connection failed: " . $conn->connect_error);
	...
	public function adminLogin(){	
		...
		if(!empty($_POST["login"]) && $_POST["email"]!=''&& $_POST["password"]!='') {	
			...
			$sqlQuery = "SELECT * FROM ".$this->userTable." 
				WHERE email='".$email."' AND password='".$password."' AND status = 'active' AND type = 'administrator'";
			$mysqli = new mysqli("localhost","root","root","sms_project");
